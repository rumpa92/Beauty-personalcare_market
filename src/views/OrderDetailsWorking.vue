<template>
  <div class="order-details-page">
    <div v-if="!orderDetails" class="loading">
          ...
          <div class="breakdown-card">
            ...
            <div class="breakdown-list">
              <div class="breakdown-item">
                ...
                <span class="breakdown-value">₹{{ orderDetails.pricing.subtotal.toFixed(2) }}</span>
              </div>
              <div class="breakdown-item">
                <span class="breakdown-label">Tax</span>
                <span class="breakdown-value">₹{{ orderDetails.pricing.tax.toFixed(2) }}</span>
              </div>
              <div v-if="orderDetails.pricing.discount > 0" class="breakdown-item discount">
                <span class="breakdown-label">Discount</span>
                <span class="breakdown-value">-₹{{ orderDetails.pricing.discount.toFixed(2) }}</span>
              </div>
              <div class="breakdown-item">
                <span class="breakdown-label">Shipping Fee</span>
                <span class="breakdown-value">
                  {{ orderDetails.pricing.shipping === 0 ? 'FREE' : '₹' + orderDetails.pricing.shipping.toFixed(2) }}
                </span>
              </div>
              <div class="breakdown-divider"></div>
              <div class="breakdown-item total">
                <span class="breakdown-label">Total Amount Paid</span>
                <span class="breakdown-value">₹{{ orderDetails.pricing.total.toFixed(2) }}</span>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      orderDetails: null,
      // Mock orders data matching the Orders component
      ordersData: [
        {
          id: '10234',
